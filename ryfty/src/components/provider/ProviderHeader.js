...
export default function ProviderHeader({ 
  ...
  if (variant === "main") {
    return (
      <header 
        className={`provider-header fixed ${className}`}
      >
                    ...
                    <div className="mobile-menu-header">
                      <div className="user-info-mobile">
                        ...
                        <div className="user-details-mobile">
                          <div className="user-name-mobile">{user?.name || 'Provider'}</div>
  ...
  return (
    <header className={`provider-topbar fixed ${className}`}>
      ...
      <div className="topbar-right">
        ...
        <div className="user-menu-container">
          ...
          {showUserMenu && (
            <div className="user-menu-dropdown topbar">
