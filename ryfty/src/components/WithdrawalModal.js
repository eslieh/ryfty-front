          ...
          <div className="modal-body">
                  ...
                  <div className="premium-info-section">
                    ...
                    {getPaymentMethodDestination() && (
                      <div className="premium-info-row">
                        ...
                        <span className="value">{getPaymentMethodDestination().type}</span>
                      </div>
                    )}
                  </div>

                  <form onSubmit={handleInitiateWithdrawal} className="withdrawal-form-premium">
            ...
            {currentStep === 'success' && (
              <div className="premium-modal-content">
                ...
                <div className="premium-status-line">
                  <div className="status-dot"></div>
                  <span>Sent today • Arriving shortly</span>
                </div>
                ...
                <div className="premium-info-section">
                  <div className="premium-info-row">
                    ...
                    <span className="value">
                      {getPaymentMethodDestination()?.type || 'Standard Payout'}
                    </span>
                  </div>
                  {transactionId && transactionId !== 'N/A' && (
                    <div className="premium-info-row">
                      <span className="label">Payout ID</span>
                      <span className="value" style={{ fontSize: '0.85rem' }}>{transactionId}</span>
                    </div>
                  )}
                </div>

                <button className="btn-premium-done" onClick={handleClose}>
                  Done
                </button>
              </div>
            )}
